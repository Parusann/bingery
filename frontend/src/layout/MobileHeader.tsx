...
export function MobileHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 md:hidden h-14 bg-bg/70 backdrop-blur-xl backdrop-saturate-150 border-b border-border flex items-center px-4">
      <Link
        to="/"
        className="font-display text-xl text-amber tracking-tight flex items-center gap-2.5 -tracking-[0.01em]"
      ...
      <button
        ...
        aria-label="Search"
        className="ml-auto -mr-1.5 w-11 h-11 flex items-center justify-center rounded-pill text-text-muted hover:text-amber transition-colors"
      >
